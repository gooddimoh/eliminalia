<div id="data-table-default_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
    ...
    <div class="row">
        <div class="col-sm-12">
            <table id="data-table-default"
                ...
                <thead>
                <tr role="row">
                    <th width="1%" class="sorting_asc" tabindex="0" aria-controls="data-table-default" rowspan="1"
                    ...
                    <th class="text-nowrap sorting" tabindex="0" aria-controls="data-table-default" rowspan="1"
                        colspan="1" style="width: 272px;"
                        aria-label="Rendering engine: activate to sort column ascending">Rendering engine
                    </th>
                    <th class="text-nowrap sorting" tabindex="0" aria-controls="data-table-default" rowspan="1"
                        colspan="1" style="width: 339px;" aria-label="Browser: activate to sort column ascending">
                        Browser
                    </th>
                    <th class="text-nowrap sorting" tabindex="0" aria-controls="data-table-default" rowspan="1"
                        colspan="1" style="width: 306px;"
                    ...
                    <th class="text-nowrap sorting" tabindex="0" aria-controls="data-table-default" rowspan="1"
                        colspan="1" style="width: 176px;" aria-label="CSS grade: activate to sort column ascending">
                        CSS grade
                    </th>
                </tr>
                </thead>
                ...
                <tr class="gradeX odd" role="row">
                    <td width="1%" class="f-w-600 text-inverse dtr-control sorting_1" tabindex="0">1</td>
                ...
                <tr class="gradeC even" role="row">
                    ...
                    <td class="with-img"><img src="../assets/img/user/user-2.jpg" class="img-rounded height-30">
                    </td>
                    <td>Trident</td>
                ...
                <tr class="gradeA odd" role="row">
                    ...
                    <td class="with-img"><img src="../assets/img/user/user-3.jpg" class="img-rounded height-30">
                    </td>
                    <td>Trident</td>
                ...
                <tr class="gradeA even" role="row">
                    ...
                    <td class="with-img"><img src="../assets/img/user/user-4.jpg" class="img-rounded height-30">
                    </td>
                    <td>Trident</td>
                ...
                <tr class="gradeA odd" role="row">
                    ...
                    <td class="with-img"><img src="../assets/img/user/user-5.jpg" class="img-rounded height-30">
                    </td>
                    <td>Trident</td>
                ...
                <tr class="gradeA even" role="row">
                    ...
                    <td class="with-img"><img src="../assets/img/user/user-6.jpg" class="img-rounded height-30">
                    </td>
                    <td>Trident</td>
                ...
                <tr class="gradeA odd" role="row">
                    ...
                    <td class="with-img"><img src="../assets/img/user/user-7.jpg" class="img-rounded height-30">
                    </td>
                    <td>Gecko</td>
                    <td>Firefox 1.0</td>
                    <td>Win 98+ / OSX.2+</td>
                ...
                <tr class="gradeA even" role="row">
                    ...
                    <td class="with-img"><img src="../assets/img/user/user-8.jpg" class="img-rounded height-30">
                    </td>
                    <td>Gecko</td>
                    <td>Firefox 1.5</td>
                    <td>Win 98+ / OSX.2+</td>
                ...
                <tr class="gradeA odd" role="row">
                    ...
                    <td class="with-img"><img src="../assets/img/user/user-9.jpg" class="img-rounded height-30">
                    </td>
                    <td>Gecko</td>
                    <td>Firefox 2.0</td>
                    <td>Win 98+ / OSX.2+</td>
                ...
                <tr class="gradeA even" role="row">
                    ...
                    <td class="with-img"><img src="../assets/img/user/user-10.jpg" class="img-rounded height-30">
                    </td>
                    <td>Gecko</td>
                    <td>Firefox 3.0</td>
                    <td>Win 2k+ / OSX.3+</td>
    ...
    <div class="row">
        <div class="col-sm-12 col-md-5">
            <div class="dataTables_info" id="data-table-default_info" role="status" aria-live="polite">Showing 1 to
                10 of 57 entries
            </div>
        </div>
        <div class="col-sm-12 col-md-7">
            <div class="dataTables_paginate paging_simple_numbers" id="data-table-default_paginate">
                <ul class="pagination">
                    <li class="paginate_button page-item previous disabled" id="data-table-default_previous"><a
                                href="#" aria-controls="data-table-default" data-dt-idx="0" tabindex="0"
                                class="page-link">Previous</a></li>
                    <li class="paginate_button page-item active"><a href="#" aria-controls="data-table-default"
                                                                    data-dt-idx="1" tabindex="0"
                                                                    class="page-link">1</a></li>
                    <li class="paginate_button page-item "><a href="#" aria-controls="data-table-default"
                    ...
                    <li class="paginate_button page-item next" id="data-table-default_next"><a href="#"
