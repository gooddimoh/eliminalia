...
(function (global, factory) {
     ...
     *
     * #### Example:
     * Given the following template, with "dashboard" being an abstract state:
     * ```html
     * <div ui-sref-active="{'active': 'dashboard.**'}">
     *   <a ui-sref-active="active" ui-sref="dashboard.roles">Roles</a>
     * </div>
     * ```
     *
     ...
     *
     * #### Example:
     * Given the following template, with "dashboard.roles" being the current state, the class will be added too:
     * ```html
     * <div ui-sref-active="{'active': ['owner.**', 'dashboard.**']}">
     *   <a ui-sref-active="active" ui-sref="dashboard.roles">Roles</a>
     * </div>
     * ```
     *
     * When the current state is "dashboard.roles" the "active" class will be applied to both the `<div>` and `<a>` elements.
